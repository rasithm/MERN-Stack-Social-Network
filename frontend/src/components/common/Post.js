...
const Post = ({ post }) => {
	...
	const {mutate : likePost , isPending : isLiking } = useMutation({
		...
		onSuccess : ( updatedLikes ) => {
			const wasLiked = post.like.includes(authUser._id);
    		const nowLiked = updatedLikes.includes(authUser._id);
			...
			// queryClient.invalidateQueries({queryKey : ['posts']}) this not correct way
